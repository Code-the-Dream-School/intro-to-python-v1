...
This is the final week of the course! You're extending the CLI tool you built in Week 10 by choosing one of two tracks: a data visualization (Option A) or a data pipeline (Option B).
...
2. **[Option A — Data Visualization with matplotlib](02_option_a_visualization.md)** <br>
...
3. **[Option B — Data Cleaning and CSV Export](03_option_b_pipeline.md)** <br>
