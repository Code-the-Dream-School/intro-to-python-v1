...
1. **[Lists and Tuples](01_lists_tuples.md)**
   *Ported from Python Essentials — PE 2.1 (Lists, Tuples, Dictionaries, and Sets — Lists & Tuples sections)*
   Creating and indexing lists; key list methods (`append`, `remove`, `sort`); slicing; mutability vs. immutability; tuples and when to use them

2. **[Dictionaries and Sets](02_dictionaries_sets.md)**
