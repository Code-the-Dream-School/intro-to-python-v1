...
| 7    | Text Data & Modules            | - Reading and writing .txt and .csv files<br>- Parsing lines into data structures (lists of dicts)<br>- Standard library modules: csv, os, datetime<br>- Intro to pip and virtual environments (conceptual)<br>- When to write your own code vs. import a module                                                            |
| 8    | Errors & Debugging             | - try/except and common runtime errors<br>- Defensive programming patterns<br>- Writing code that fails gracefully                                                                                                                                                                                                          |
